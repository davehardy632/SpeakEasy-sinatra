...
class LaunchResponse
  ...
  def render_response
      ...
      "response": {
        "outputSpeech": {
          "type": "PlainText",
          "text": "Welcome to speakeasy messages, You can ask about workflow from a github project, and shoutouts from a predefined slack group",
  ...
  # changed should end session to false for testing
end
